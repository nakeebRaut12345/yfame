  ...
  return (
    <section className="py-15 md:py-25 border-t border-border relative overflow-hidden bg-mesh grain">
      ...
      <div className="capitalize max-w-5xl mx-auto text-center px-6 relative z-10">
        <div className="capitalize text-2xl md:text-4xl font-bold leading-[1.5] mb-8 ">We think <span className="text-serif italic">strategically</span>, not <span className="text-serif italic">differently</span></div>
        ...
        <div className="mt-14 grid w-full max-w-lg mx-auto grid-cols-1 md:grid-cols-2 gap-5">
          <a
            href="mailto:info@yfame.in"
            className="group relative inline-flex w-full items-center justify-center gap-3 overflow-hidden px-10 py-5 rounded-full bg-primary text-primary-foreground font-medium text-lg transition-all duration-500 hover:scale-[1.05] shadow-[0_20px_60px_-15px_var(--color-primary)] hover:shadow-[0_0_32px_0_oklch(0.65_0.19_250/0.55),0_24px_64px_-12px_var(--color-primary)]"
          >
            ...
            <Mail className="relative size-9 shrink-0" aria-hidden />
          ...
          <a
            ...
            className="group relative inline-flex w-full items-center justify-center gap-3 overflow-hidden rounded-full bg-gradient-to-br from-[#f58529] via-[#dd2a7b] to-[#8134af] px-10 py-5 text-lg font-medium text-white shadow-[0_20px_60px_-15px_#dd2a7b] transition-all duration-300 hover:scale-[1.05] hover:shadow-[0_0_32px_0_#dd2a7b88,0_24px_64px_-12px_#8134af]"
          >
